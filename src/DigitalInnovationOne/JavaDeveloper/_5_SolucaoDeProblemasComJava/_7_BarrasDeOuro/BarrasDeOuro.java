package DigitalInnovationOne.JavaDeveloper._5_SolucaoDeProblemasComJava._7_BarrasDeOuro;
...
public class BarrasDeOuro {
    ...
    public static void main(String[] args) {
        ...
        cargoCapacity = Integer.parseInt(lineArgs[1]);
        ...
        BarrasDeOuro goldBars = new BarrasDeOuro();

        for (int i = 0; i < N; i++) {
            Vertex city = new Vertex(taxQuantities.get(i));
            cities.add(city);
        }
    ...
    static class Vertex {
        ...
        public int calculateTotalDistance(Vertex previousCity) {
            ...
            for (Edge edge : edgesList) {
                ...
                travelsNumber = (int) Math.ceil(edge.destinationVertex.taxQuantity / BarrasDeOuro.cargoCapacity) * 2;
